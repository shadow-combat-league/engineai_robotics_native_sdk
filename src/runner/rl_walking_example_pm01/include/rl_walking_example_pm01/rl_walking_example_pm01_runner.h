...
#include "rl_walking_example_pm01_param/rl_walking_example_pm01_param.h"
...
class RlWalkingExamplePm01Runner : public MotionRunner {
 public:
  RlWalkingExamplePm01Runner(std::string_view name, const std::shared_ptr<data::DataStore>& data_store);
 ...
 private:
  ...
  std::shared_ptr<data::RlWalkingExamplePm01Param> param_;
...
REGISTER_RUNNER(RlWalkingExamplePm01Runner, "rl_walking_example_pm01_runner", kMotion)
